  ...
  return (
    <section className="relative overflow-hidden  px-4 sm:px-6 lg:px-8 py-16 md:py-24">
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-purple-900 mb-6">
          Reinventa tu negocio con Tikneo
        </h2>
        <p className="text-purple-800/90 text-base md:text-lg leading-relaxed mb-10">
        ...
        <ul className="space-y-3 mb-12 text-left max-w-xl mx-auto">
          {reasons.map((reason, index) => (
            <li key={index} className="flex items-start gap-3 text-purple-900/90">
        ...
        <div className="grid sm:grid-cols-2 gap-6 max-w-2xl mx-auto">
          <Link
            href="/demo"
            className="block bg-white rounded-2xl shadow-md border border-gray-100 p-6 md:p-8 text-purple-900 font-semibold text-center hover:shadow-lg transition-shadow"
          >
            Mejora procesos horarios con nuestra aplicación
          </Link>
          <Link
            href="/price"
            className="block rounded-2xl shadow-md p-6 md:p-8 text-white font-semibold text-center bg-linear-to-r from-purple-500 to-blue-600 hover:from-purple-600 hover:to-blue-700 transition-all"
          >
