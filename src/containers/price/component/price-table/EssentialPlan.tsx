    ...
    <div className="bg-primary/10 rounded-2xl shadow-md border border-gray-200 p-3">
      <div className="rounded-2xl shadow-md border border-gray-200 p-6 md:p-8 flex flex-col">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h3 className="text-xl font-bold text-primary">Plan Esencial</h3>
        </div>
        ...
        <div className=" rounded-2xl shadow-md border border-gray-200 p-6 md:p-8 flex flex-col">
          <p className="text-gray-800 mb-2">
            ...
            <span className="text-primary">24.99 €/mes + IVA</span>
          </p>
          ...
          <Link
            href="/demo"
            className="block w-full py-3 rounded-full font-semibold text-center bg-primary hover:opacity-90 text-white transition-colors"
          >
