...
export default function ComparativeTable() {
  return (
    <div className="max-w-7xl mx-auto w-full">
      <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-primary text-center mb-3 px-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-6 lg:gap-8 items-start">
        ...
        <div className="bg-primary/10 rounded-2xl shadow-md border border-primary/15 overflow-hidden -mx-2 sm:mx-0">
          <div className="overflow-x-auto overscroll-x-contain scrollbar-hide">
            <table className="w-full min-w-[380px]">
              <thead>
                <tr className="border-b border-primary/15">
                  <th className="text-left py-4 px-4 md:px-6 text-primary font-bold">
                    Características
                  </th>
                  <th className="text-center py-4 px-4 md:px-6 text-primary font-bold">
                    Plan Básico
                  </th>
                  <th className="text-center py-4 px-4 md:px-6 text-primary font-bold">
              ...
              <tbody>
                {comparisonRows.map((row, i) => (
                  ...
                  >
                    <td className="py-3 px-4 md:px-6 text-primary text-sm md:text-base">
                      {row.feature}
                    </td>
          ...
          {/* Leyenda */}
          <div className="flex flex-wrap justify-center gap-6 py-4 px-4 bg-primary/5 border-t border-primary/10 text-sm text-primary">
